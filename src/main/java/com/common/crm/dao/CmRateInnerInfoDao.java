...
@MapperScan
public interface CmRateInnerInfoDao {
	...
	* @param pid	编码
	 ...
	 * @return [{company,channel,kind,rate,stime }]
	 */
	public List<HashMap> queryMax(@Param("company")String company,
			@Param("channel")String channel,
			@Param("kind")String kind,
			@Param("stime")String stime);
	...
	public List<HashMap> query(
			...
			@Param("channel")String channel,
			@Param("kind")String kind,
			@Param("underwrite_date")String underwrite_date);
	 ...
	 * @param pid	编码
	 */
	public int delete(@Param("pid")String pid);
}
